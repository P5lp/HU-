...
-- >>> قسم جذب الأغراض / Item Spawner <<<


-- تحديث الترجمة
translations.Arabic.spawnItemTab = "🧲 جذب الأغراض"
translations.Arabic.spawnItemInput = "اكتب اسم الأداة لجذبها"
translations.Arabic.itemSpawned = "تم جلب الأداة:"
translations.Arabic.itemNotFound = "لم يتم العثور على الأداة"

translations.English.spawnItemTab = "🧲 Item Spawner"
